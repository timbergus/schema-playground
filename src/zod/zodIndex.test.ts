...
import { getSchema, type User } from './zodIndex'
...
describe('The schema validation for the allOptionalModel', () => {
  test('should work if the schema is empty', () => {
    ...
    expect(getSchema(allOptionalModel).safeParse(data).success).toBe(true)
  })
...
describe('The schema validation for the allRequiredModel', () => {
  test('should fail if the schema is empty', () => {
    ...
    expect(getSchema(allRequiredModel).safeParse(data).success).toBe(false)
  })
...
describe('The schema validation for the streetRequiredModel', () => {
  ...
  test('should work if the street is required and not empty for Gustavo', () => {
    const data: User = {
      name: 'Gustavo',
      surname: null,
      age: null,
    ...
    expect(getSchema(streetRequiredModel).safeParse(data).success).toBe(true)
  })

  test('should fail if the street is required and empty for Gustavo', () => {
    const data: User = {
      name: 'Gustavo',
      surname: null,
      age: null,
    ...
    expect(getSchema(streetRequiredModel).safeParse(data).success).toBe(false)
  })

  test('should work if the street is required and empty but for other person', () => {
    const data: User = {
      name: 'John',
      surname: null,
      age: null,
